...
VCMS 슬랙 채널(`#system-vcms-noti`)의 메시지를 AI가 자동으로 읽고, **일간/주간 리포트**를 만들어서 슬랙에 올려주는 시스템입니다.
...
| 종류 | 언제 | 내용 |
|------|------|------|
| **일간 리포트** | 월~목 오전 10시 | 전날 메시지 요약 |
| **주간 리포트** | 금요일 오전 10시 | 월~목 전체 종합 분석 |
...
| 구성요소 | 역할 | 비용 |
|---------|------|------|
| GitHub Actions | 매일 10시 자동 실행 | 무료 |
| Claude API | 리포트 작성 AI | 월 ~$1 미만 |
